...
public class PurchaseClsView extends javax.swing.JFrame {
    ...
    private void btnPurchaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPurchaseActionPerformed
        ...
        PurchaseCls p = new PurchaseCls(txtPCode.getText(), txtPName.getText(), (int) Double.parseDouble(txtUnitPrice.getText()), Integer.parseInt(txtQty.getText()), Double.parseDouble(txtTotalPrice.getText()), new Date(), pc, uc);
    ...
    private void txtQtyKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtQtyKeyTyped
        ...
        x = (int) Double.parseDouble(txtUnitPrice.getText());
